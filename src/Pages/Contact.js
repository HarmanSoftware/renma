...
export default function Contact() {
  ...
  return (
    <div>
      <div className='container mx-auto text-center text-3xl font-medium bg-soft-purple rounded-lg p-6 mt-8 text-white'>Contact Renma</div>
      <div className='container mx-auto grid lg:grid-cols-2 sm:w-auto sm:grid-cols-1 p-8'>
        <div className='bg-soft-purple rounded-l-lg my-4' id="contact-us">
<form className='p-4'>  
...
<div class="relative z-0 mb-6 w-full group py-1">
  ...
  Send</button>
        ...
        <div className='bg-lightpurple rounded-lg p-6' id='contact-info'>            
         ...
         <div className='text-center'>
          <img className='hover:scale-105 ease-in-out duration-500' src={ContactUs} alt='Contact us img'/>
         </div>
         <div id="contact-info-phone" className='flex items-center font-medium py-2 my-2 text-xl rounded-lg bg-white shadow hover:shadow-md hover:scale-105 ease-in-out duration-500 '>
         ...
         <div id="contact-info-email" className='flex items-center font-medium py-2 my-2 text-xl rounded-lg bg-white shadow hover:shadow-md hover:scale-105 ease-in-out duration-500 '>
